...
class Clothing {
	class bruce {
		...
		uniforms[] = {
			...
			{ "U_C_Scientist", "The White Look", 1400, { "", "", -1 } },
			{ "U_C_Journalist", "Journalist", 1900, { "", "", -1 } },
			{ "U_Marshal", "Marshal", 2000, { "", "", -1 } },
			{ "U_NikosBody", "Nikos Body", 2200, { "", "", -1 } },
		...
		headgear[] = {
			...
			{ "H_Cap_red", "", 150, { "", "", -1 } },
			{ "H_Cap_tan", "", 150, { "", "", -1 } },
			{ "H_Cap_surfer", "Surfer Cap", 150, { "", "", -1 } },
			{ "H_Cap_press", "Presse Cap", 150, { "", "", -1 } }
		};
	...
	class cop {
		...
		uniforms[] = {
			...
			{ "U_B_Wetsuit", "", 550, { "life_coplevel", "SCALAR", 3 } },
			{ "U_O_FullGhillie_sard", "", 1550, { "life_coplevel", "SCALAR", 6 } },
			{ "U_B_CombatUniform_mcam", "", 550, { "life_coplevel", "SCALAR", 2 } }
		};

		headgear[] = {
			{ "NONE", "Remove Hat", 0, { "", "", -1 } },
			{ "H_HelmetB_plain_mcamo", "", 75, { "life_coplevel", "SCALAR", 1 } },
			{ "H_Cap_police", "", 80, { "life_coplevel", "SCALAR", 1 } },
			{ "H_Booniehat_mcamo", "", 120, { "life_coplevel", "SCALAR", 1 } },
			{ "H_MilCap_mcamo", "", 100, { "life_coplevel", "SCALAR", 2 } },
			{ "H_Beret_blk_POLICE", "", 200, { "life_coplevel", "SCALAR", 2 } },
			{ "H_Watchcap_blk", "", 100, { "life_coplevel", "SCALAR", 3 } },
			{ "H_Beret_ocamo", "", 100, { "life_coplevel", "SCALAR", 3 } },
			{ "H_Watchcap_khk", "", 100, { "life_coplevel", "SCALAR", 3 } },
			{ "H_BandMask_blk", "", 100, { "life_coplevel", "SCALAR", 4 } },
			{ "H_Beret_Colonel", "", 100, { "life_coplevel", "SCALAR", 5 } },
		...
		vests[] = {
			...
			{ "V_TacVest_blk", "", 1500, { "life_coplevel", "SCALAR", 2 } },
			{ "V_RebreatherIA", "", 1500, { "life_coplevel", "SCALAR", 3 } },
			{ "V_PlateCarrierSpec_mtp", "", 1500, { "life_coplevel", "SCALAR", 7 } },
	...
	class reb {
		...
		vests[] = {
			...
			{ "V_PlateCarrier_Kerry", "", 16500, { "", "", -1 } },
			{ "V_TacVestCamo_khk", "", 14500, { "", "", -1 } },
			{ "V_TacVest_camo", "", 44500, { "", "", -1 } },
