	...
	*/
	...
	class med_shop {
		...
		vehicles[] = {
			...
			{ "B_Truck_01_transport_F", 60000,"", {"life_mediclevel", 3 } },
			{ "B_MRAP_01_F", 60000, "", {"life_mediclevel", 5 } }			
		};
	};
	...
	class med_air_hs {
		...
		vehicles[] = {
			...
			{ "I_Heli_Transport_02_F", 75000, "mAir" }
		};
	};
	...
	class civ_truck {
		side = "civ";
		vehicles[] = {
			{ "C_Van_01_box_F", 80000, "trucking" },
			{ "I_Truck_02_transport_F", 95000, "trucking" },
			{ "I_Truck_02_covered_F", 120000, "trucking" },
			{ "O_Truck_02_fuel_F", 110000, "trucking" },
			{ "B_Truck_01_transport_F", 275000, "trucking" },
			{ "B_Truck_01_box_F", 500000, "trucking" },
			{ "O_Truck_03_transport_F", 250000, "trucking" },
			{ "O_Truck_03_covered_F", 300000, "trucking" },
			{ "O_Truck_03_fuel_F", 450000, "trucking" },
			{ "O_Truck_03_device_F", 550000, "trucking" }
		};
	};
	...
	class reb_car {
		...
		vehicles[] = {
			...
			{ "O_MRAP_02_F", 250000, "" },
			{ "I_MRAP_03_F", 550000, "" },
			{ "B_Heli_Transport_03_unarmed_green_F", 625000, "" },
			{ "O_Heli_Transport_04_bench_F", 725000, "" },
			{ "I_Heli_light_03_unarmed_F", 825000, "" },
	...
	class cop_car {
		...
		vehicles[] = {
			{ "C_Offroad_01_F", 5000, ""},
			{ "C_SUV_01_F", 20000, "" },
			{ "C_Hatchback_01_sport_F", 20000, "", { "life_coplevel", 3 } },
			{ "B_MRAP_01_F", 30000, "", { "life_coplevel", 5 } },
			{ "I_MRAP_03_F", 30000, "", { "life_coplevel", 6 } }
		};
	};
	...
	class civ_air {
		...
		vehicles[] = {
			...
			{ "O_Heli_Transport_04_F", 653000, "pilot" },
			{ "O_Heli_Transport_04_box_F", 753000, "pilot" },
			{ "O_Heli_Transport_04_covered_F", 753000, "pilot" },
			{ "I_Heli_Transport_02_F", 553000, "pilot" }
		};
	};
	...
	class cop_air {
		...
		vehicles[] = {
			...
			{ "B_Heli_Transport_03_unarmed_F", 200000, "cAir", { "life_coplevel", 4 } },
			{ "I_Heli_light_03_unarmed_F", 300000, "cAir", { "life_coplevel", 5 } },
		};
	};
	...
	class cop_airhq {
		...
		vehicles[] = {
			{ "B_Heli_Light_01_F", 75000, "cAir" },
			{ "B_Heli_Transport_01_F", 200000, "cAir", { "life_coplevel", 3 } },
			{ "B_Heli_Transport_03_unarmed_F", 750000, "", { "life_coplevel", 3 } }
		};
	};
...
class CfgVehicles {
	...
	class O_MRAP_02_F {
        ...
        textures[] = { 
		    { "Camo Rot", "reb", {
                "skins\car\ifrit_r1.paa",
				"skins\car\ifrit_r2.paa"
            } },
			{ "Desert Digi", "reb", {
	...
	class I_MRAP_03_F {
        ...
        textures[] = { 
		    { "Bundespolizei", "cop", {
                "skins\car\pol_Strider.paa"
            } },
			{ "Camo", "reb", {
                "skins\car\strider.paa"
            } },
			{ "Digi Green", "reb", {
	...
	class C_Offroad_01_F {
        ...
        textures[] = {
			...
			{ "Rockstar Gelb", "civ", {
	                "skins\car\civ_offroad_rockstargelb.paa"
            } },
			{ "Rockstar Lila", "civ", {
	                "skins\car\civ_offroad_rockstarlila.paa"
            } },
			{ "Blue / White", "civ", {
	...
	class C_Hatchback_01_sport_F {
        ...
        textures[] = {
			...
			{ "Monster", "civ", {
	                "skins\car\hatchback_sport_ken_block.paa"
	        } },
			{ "Streife", "cop", {
	...
	class B_Quadbike_01_F {
        ...
        textures[] = {
			...
			{ "Hyper Beast", "civ", {
	                "skins\car\HyperBeast_quadbike.paa"
	        } },
	        { "Rebel Camo", "reb", {
                "\a3\soft_f_gamma\Quadbike_01\data\quadbike_01_indp_hunter_co.paa"
            } }
	...
	class C_SUV_01_F {
        ...
        textures[] = {
			...
			{ "Carbon", "civ", {
                "skins\car\carbon_suv.paa"
            } },
		    { "Ferrari", "civ", {
                "skins\car\civ_suv_ferrari.paa"
            } },
			{ "Monster", "civ", {
                "skins\car\civ_suv_monster.paa"
            } },
			{ "THW", "med", {
	                "skins\car\thw_suv.paa"
            } },
			{ "Streife", "cop", {
	                "skins\car\pol_SUV.paa"
            } },
			{ "Zivil 1", "cop", {
	                "skins\car\carbon_suv.paa"
            } },
	...
	class C_Van_01_box_F {
        ...
        textures[] = {
		    ...
		    { "THW", "med", {
	            "skins\car\thw_truckbox_01.paa",
				"skins\car\thw_truckbox_02.paa"
            } },
            { "Red", "civ", {
                "\a3\soft_f_gamma\Van_01\Data\van_01_ext_red_co.paa"
            } }
	...
	class B_MRAP_01_F {
        ...
        textures[] = {
        	{ "Streife", "cop", {
                "skins\car\pol_hunter.paa",
				"skins\car\pol_hunter2.paa"
            } },
			{ "Einsatz Leitung", "cop", {
                "skins\car\pol_hunter_l.paa",
				"skins\car\pol_hunter2.paa"
            } },
			{ "THW", "med", {
	            "skins\car\thw_hunterfront.paa",
				"skins\car\thw_hunterback.paa"
            } },
            { "Black", "cop", {
                "#(argb,8,8,3)color(0.05,0.05,0.05,1)"
            } }
	...
	class B_Heli_Light_01_F {
        ...
        textures[] = {
        	{ "Polizei", "cop", {
                "skins\air\pol_hummingbird.paa"
            } },
			{ "Busch Camo", "reb", {
                "skins\air\hummingbird_Comoflage.paa"
            } },
			{ "Redbull", "civ", {
			...
			{ "Medic", "med", {
                "skins\air\medic_littlebird.paa"
            } },
            { "EMS White", "med", {
	...
	class B_Heli_Transport_03_unarmed_F {
        ...
        textures[] = {
			{ "Polizei", "cop", {
	                "skins\air\polizeihuron_vorne.paa",
					"skins\air\polizeihuron_hinten.paa"
            } }
        };
    };
